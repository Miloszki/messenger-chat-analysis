...
MESSENGER_BUILTIN_MESSAGES = ['voice call', 'pinned a message','created a poll',' set the nickname for', 'voted for', 'changed their vote', 'to your message', 'sent an attachment', 'to the poll', 'multiple updates']
